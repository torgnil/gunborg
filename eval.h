...
const int PAWN_PSQT_BASE_VALUE_MG = 28;
...
const int PAWN_PSQT_BASE_VALUE_EG = 37;
const int PAWN_CENTER_BONUS_EG = 0;
const int PAWN_CENTER_S_MAX_EG = 0;
const int PAWN_OPPONENT_BACK_ROW_BONUS_EG = 204;
const int PAWN_OPPONENT_BACK_ROW_S_MAX_EG = 9;

const int KNIGHT_PSQT_BASE_VALUE = 293;
const int KNIGHT_CENTER_BONUS = 19;
const int KNIGHT_CENTER_S_MAX = 3;
const int KNIGHT_OPPONENT_BACK_ROW_BONUS = 2;
const int KNIGHT_OPPONENT_BACK_ROW_S_MAX = 12;

const int BISHOP_PSQT_BASE_VALUE = 248;
const int BISHOP_CENTER_BONUS = 72;
const int BISHOP_CENTER_S_MAX = 13;
const int BISHOP_OPPONENT_BACK_ROW_BONUS = 2;
